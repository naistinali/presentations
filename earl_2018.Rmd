...
- Sample of 12,000 checks of companies

- 1 out of 10 companies are fraudulent

- 150 features

- Predict fraudulent companies 
...
Until recently we have trained models one at the time - often using the 'caret' package:
...
Set parameters, that control the model training (including resampling scheme, 
...
For that reason we developed the ##modelgrid## package. It is a pipe-friendly
framework to construct, manage and train (potentially many) ##caret## models.
