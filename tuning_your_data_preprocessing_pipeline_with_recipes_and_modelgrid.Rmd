...
First, let us take a quick look at the data by inspecting the between-predictor
correlations of the predictors as expressed by a correlation matrix of the 
...
positive correlations (dark blue), i.e. "collinearity clusters".

NÅET HERTIL!!!!!!!

in fact clusters of correlated predictors. This
